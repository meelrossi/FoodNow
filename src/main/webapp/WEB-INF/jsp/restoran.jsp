	...
	<div class="restaurant-info">
		...
		<div class="row">
			...
			<div class="col-md-6 restaurant-detail">
				<h4>${restaurant.Address.Street} ${restaurant.Address.Number}</h4>
				<h5>Horario</h5>
			</div>
		</div>
		<div class="row menus">
			...
			<div class="menu-type-container">
				<c:forEach var="menutype" items="${restaurant.menu}">
					<h3 class="menu-type">${menutype.CategoryName}</h3>
					<div class="media">
							...
							<div class="row">
								...
								<a class="media-left" href="#">
									...
									<div class="media-body">
										<h4 class="media-heading user_name">${dish.Name}</h4>
										<br>${dish.Description}</br>
									</div>
								</div>
